...
const OrderCard = ({
  ...
  return (
    <div className="flex justify-evenly items-center rounded-md my-5 w-fill p-4 border-2">
      <div className="flex space-x-[24px] items-center p-4">
        <Image src={img} width={120} height={120} alt={"picture"} />
      ...
      <div className="col-span-3 flex flex-col justify-center h-20 w-4/12">
        <div className="flex gap-5 items-center ">
          ...
          <h1 className="font-medium text-[#5F72FF]">
