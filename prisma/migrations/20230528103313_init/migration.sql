...
-- AddForeignKey
ALTER TABLE "Shipping" ADD CONSTRAINT "Shipping_originAddressId_fkey" FOREIGN KEY ("originAddressId") REFERENCES "Address"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
